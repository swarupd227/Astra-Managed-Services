...
export const AGENTS: Agent[] = [
  {
    ...
    towers: ['twr_payments', 'twr_core', 'twr_cloud', 'twr_network', 'twr_euc', 'twr_dataplat', 'twr_bi'],
  ...
  },
  {
    ...
    towers: ['twr_payments', 'twr_core', 'twr_cloud', 'twr_dataplat', 'twr_network', 'twr_bi'],
  ...
  },
  {
    ...
    mission: 'Reproduce application defects, generate fixes and tests, open pull requests with reviewer-grade narratives for the SAP/PeopleSoft/ServiceNow estate, and author pipeline and schema changes for the data platform against its contracts.',
    ownerHuman: 'A. Fernandes', nhi: 'spiffe://kearney/astra/agt_forge', origin: 'artizent',
    towers: ['twr_payments', 'twr_core', 'twr_dataplat'],
    skills: ['sk_repro_v4', 'sk_patch_v8', 'sk_testgen_v6', 'sk_pipeline_build_v2'], prohibited: ['AC-12', 'AC-31', 'AC-58', 'AC-71'],
    grants: { 'AC-05': 'A', 'AC-37': 'B', 'AC-44': 'C' }, ceiling: 'approve_first',
  ...
  },
  {
    ...
    skills: ['sk_pipe_repair_v9', 'sk_backfill_v4', 'sk_dq_probe_v7', 'sk_contract_draft_v2', 'sk_bi_refresh_v4'], prohibited: ['AC-58', 'AC-71'],
  ...
  },
  {
    ...
    skills: ['sk_spend_anomaly_v7', 'sk_rightsize_v5', 'sk_query_tune_v3'], prohibited: ['AC-31', 'AC-58', 'AC-71'],
  ...
  },
  {
    ...
    towers: TOWERS.map((t) => t.id),
    skills: ['sk_reverse_v11', 'sk_runbook_draft_v9', 'sk_interview_v4', 'sk_lineage_map_v3', 'sk_pii_locate_v2'], prohibited: ['AC-12', 'AC-31', 'AC-37', 'AC-58', 'AC-71'],
    grants: { 'AC-05': 'A', 'AC-08': 'A' }, ceiling: 'autonomous',
  ...
  },
  {
    ...
    mission: 'Fulfil hardware and cloud-application-access requests end to end — the two largest Service Catalog task types — provisioning from the approved catalog within policy, and dataset access under the data owner\'s approval.',
    ownerHuman: 'M. Okonkwo', nhi: 'spiffe://kearney/astra/agt_concierge', origin: 'artizent',
    towers: ['twr_euc', 'twr_cloud', 'twr_dataplat', 'twr_bi'],
...
export const SKILLS: Skill[] = [
  ...
  { id: 'sk_pipeline_build_v2', name: 'Pipeline and schema change authoring', version: 'v2.0.1', layer: 'platform', actionClasses: ['AC-37', 'AC-44'], successRate: 0.921, runs: 184, evalScore: 0.887, verificationPack: 'dq_contract_v5', owner: 'A. Fernandes', updatedAt: T(9) },
  { id: 'sk_contract_draft_v2', name: 'Data contract drafting', version: 'v2.2.0', layer: 'platform', actionClasses: ['AC-05'], successRate: 0.944, runs: 96, evalScore: 0.912, verificationPack: 'none', owner: 'S. Okafor', updatedAt: T(6) },
  { id: 'sk_bi_refresh_v4', name: 'Semantic model refresh repair', version: 'v4.0.2', layer: 'platform', actionClasses: ['AC-12'], successRate: 0.973, runs: 412, evalScore: 0.921, verificationPack: 'health_probe_v4', owner: 'S. Okafor', updatedAt: T(20) },
  { id: 'sk_lineage_map_v3', name: 'Lineage discovery', version: 'v3.1.0', layer: 'platform', actionClasses: ['AC-05'], successRate: 0.958, runs: 1240, evalScore: 0.93, verificationPack: 'none', owner: 'Platform core', updatedAt: T(17) },
  { id: 'sk_pii_locate_v2', name: 'Personal-data location', version: 'v2.0.3', layer: 'platform', actionClasses: ['AC-05'], successRate: 0.962, runs: 318, evalScore: 0.927, verificationPack: 'none', owner: 'Platform core', updatedAt: T(24) },
  { id: 'sk_query_tune_v3', name: 'Query and workload tuning', version: 'v3.0.0', layer: 'platform', actionClasses: ['AC-05', 'AC-18'], successRate: 0.938, runs: 226, evalScore: 0.901, verificationPack: 'capacity_probe_v2', owner: 'Platform core', updatedAt: T(30) },
