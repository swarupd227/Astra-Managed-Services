...
export const DEMAND_CLASSES: DemandClassRec[] = [
  { id: 'dc_cert_expiry', name: 'Certificate expiry incidents', tower: 'twr_payments', volumeYr: 31, hoursYr: 47, trend: -0.88, cause: 'No certificate lifecycle automation on legacy VM estate (210 graph nodes)', eliminationState: 'verifying', projectedRemoval: 0.92, npv36m: 41000, effortDays: 6, observedDecay: -0.88, verifyDay: 22, proposalType: 'automation' },
  { id: 'dc_conn_pool_exhaustion', name: 'DB connection-pool exhaustion', tower: 'twr_payments', volumeYr: 44, hoursYr: 70, trend: -0.31, cause: 'Pool sizing not guard-railed in IaC; change chg_5511 pattern recurs', eliminationState: 'approved', projectedRemoval: 0.85, npv36m: 58000, effortDays: 9, proposalType: 'engineering_fix' },
  { id: 'dc_ftp_stall', name: 'Legacy FTP batch stall', tower: 'twr_payments', volumeYr: 118, hoursYr: 190, trend: -0.94, cause: 'Brittle SFTP batch interface with no idempotent retry', eliminationState: 'eliminated', projectedRemoval: 0.94, npv36m: 212000, effortDays: 34, observedDecay: -0.94, verifyDay: 75, proposalType: 'modernisation' },
  { id: 'dc_batch_overrun', name: 'Core batch window overrun', tower: 'twr_core', volumeYr: 62, hoursYr: 165, trend: -0.12, cause: 'Contention between accrual job and replication catch-up', eliminationState: 'candidate', projectedRemoval: 0.7, npv36m: 96000, effortDays: 21, proposalType: 'engineering_fix' },
  { id: 'dc_mq_depth', name: 'MQ channel depth alarms', tower: 'twr_core', volumeYr: 204, hoursYr: 112, trend: -0.44, cause: 'Static alarm thresholds unrelated to business calendar', eliminationState: 'approved', projectedRemoval: 0.8, npv36m: 61000, effortDays: 7, proposalType: 'policy_change' },
  { id: 'dc_pipeline_fail', name: 'Pipeline failure — upstream schema drift', tower: 'twr_dataplat', volumeYr: 156, hoursYr: 288, trend: -0.52, cause: 'No enforced data contract on the customer feed', eliminationState: 'verifying', projectedRemoval: 0.78, npv36m: 148000, effortDays: 18, observedDecay: -0.61, verifyDay: 44, proposalType: 'engineering_fix' },
  { id: 'dc_dq_null_ratio', name: 'Data-quality null-ratio breaches', tower: 'twr_dataplat', volumeYr: 87, hoursYr: 131, trend: -0.19, cause: 'DQ rules authored per-report rather than per-asset', eliminationState: 'candidate', projectedRemoval: 0.65, npv36m: 54000, effortDays: 12, proposalType: 'automation' },
  { id: 'dc_node_pressure', name: 'AKS node memory pressure', tower: 'twr_cloud', volumeYr: 240, hoursYr: 160, trend: -0.71, cause: 'Absent vertical pod autoscaling on 14 workloads', eliminationState: 'eliminated', projectedRemoval: 0.9, npv36m: 88000, effortDays: 5, observedDecay: -0.9, verifyDay: 90, proposalType: 'automation' },
  { id: 'dc_tf_drift', name: 'Terraform state drift findings', tower: 'twr_cloud', volumeYr: 312, hoursYr: 208, trend: -0.28, cause: 'Console changes outside the pipeline by two platform teams', eliminationState: 'approved', projectedRemoval: 0.75, npv36m: 74000, effortDays: 10, proposalType: 'policy_change' },
  { id: 'dc_pwd_reset', name: 'Password / MFA lockout resets', tower: 'twr_euc', volumeYr: 4820, hoursYr: 1446, trend: -0.96, cause: 'No self-service path for post-MFA-re-enrolment lockouts', eliminationState: 'eliminated', projectedRemoval: 0.96, npv36m: 384000, effortDays: 11, observedDecay: -0.96, verifyDay: 90, proposalType: 'self_service' },
  { id: 'dc_profile_corrupt', name: 'Workplace profile corruption', tower: 'twr_euc', volumeYr: 640, hoursYr: 373, trend: -0.62, cause: 'Policy push races with roaming profile sync', eliminationState: 'verifying', projectedRemoval: 0.72, npv36m: 121000, effortDays: 14, observedDecay: -0.58, verifyDay: 31, proposalType: 'engineering_fix' },
  ...
  { id: 'dc_vpn_degraded', name: 'Branch VPN degradation', tower: 'twr_network', volumeYr: 178, hoursYr: 237, trend: -0.34, cause: 'No automated failover to secondary carrier on jitter threshold', eliminationState: 'candidate', projectedRemoval: 0.6, npv36m: 82000, effortDays: 16, proposalType: 'engineering_fix' },
  ...
  { id: 'dc_cve_image', name: 'Critical CVE on base images', tower: 'twr_secops', volumeYr: 96, hoursYr: 288, trend: -0.41, cause: 'Base images not rebuilt on a cadence; 31 downstream repos', eliminationState: 'approved', projectedRemoval: 0.82, npv36m: 134000, effortDays: 19, proposalType: 'automation' },
...
export const TRANSFORM: TransformLedger[] = [
  {
    ...
    allocations: [
      { id: 'ta_007', title: 'Retire legacy FTP batch interface', credits: 300, approvedIn: 'gov_2026_11', state: 'delivered', yieldPromised: 190, yieldRealised: 214 },
      { id: 'ta_031', title: 'Decommission legacy report estate', credits: 260, approvedIn: 'gov_2027_02', state: 'executing', yieldPromised: 140 },
      { id: 'ta_034', title: 'API-enable batch interface X', credits: 380, approvedIn: 'gov_2027_02', state: 'approved', yieldPromised: 175 },
    ],
  },
  {
    ...
    allocations: [
      { id: 'ta_012', title: 'Vertical pod autoscaling across 14 workloads', credits: 180, approvedIn: 'gov_2026_10', state: 'delivered', yieldPromised: 130, yieldRealised: 158 },
      ...
      { id: 'ta_040', title: 'Self-healing probes for 22 tier-2 workloads', credits: 220, approvedIn: 'gov_2027_02', state: 'approved', yieldPromised: 96 },
    ],
  },
  {
    ...
    allocations: [
      ...
      { id: 'ta_044', title: 'Roaming profile sync hardening', credits: 300, approvedIn: 'gov_2027_02', state: 'executing', yieldPromised: 268 },
    ],
  },
  {
    ...
    freezeReason: 'XLA friction index breached target for FINREP consumers — new credit allocation frozen until service is restored (§12.5).',
    allocations: [
      { id: 'ta_022', title: 'Enforce data contracts on customer feed', credits: 120, approvedIn: 'gov_2026_12', state: 'verifying', yieldPromised: 224 },
    ],
  },
  {
    ...
    allocations: [
      { id: 'ta_025', title: 'Business-calendar-aware MQ alarm thresholds', credits: 210, approvedIn: 'gov_2027_01', state: 'executing', yieldPromised: 90 },
    ],
  },
]
...
export const SLAS: SlaSpec[] = [
  { id: 'sla_pmt_p1', tower: 'twr_payments', name: 'P1 resolution — Retail Payments', metric: 'resolution_time', targetMins: 60, attainmentTarget: 98, attainmentMtd: 100, volumeMtd: 3, breachesMtd: 0, headroom: 3, kind: 'sla', clock: { start: 'validated_priority_set', stop: 'resolution_confirmed', pauses: ['awaiting_client (cap 8h/wo)', 'vendor_dependency (logged)'], calendar: '24×7' }, credit: [{ band: '96–98%', pct: 3 }, { band: '92–96%', pct: 6 }, { band: '<92%', pct: 10 }], earnback: '3 consecutive months ≥ 99%' },
  { id: 'sla_pmt_p2', tower: 'twr_payments', name: 'P2 resolution — Retail Payments', metric: 'resolution_time', targetMins: 240, attainmentTarget: 95, attainmentMtd: 96.8, volumeMtd: 62, breachesMtd: 2, headroom: 2, kind: 'sla', clock: { start: 'validated_priority_set', stop: 'resolution_confirmed', pauses: ['awaiting_client (cap 8h/wo)', 'vendor_dependency (logged)', 'change_freeze_client_initiated'], calendar: 'client_biz_hours(Europe/Berlin)' }, credit: [{ band: '94–95%', pct: 2 }, { band: '90–94%', pct: 4 }, { band: '<90%', pct: 7 }], earnback: '3 consecutive months ≥ 97%' },
  { id: 'sla_core_p2', tower: 'twr_core', name: 'P2 resolution — Core Deposits', metric: 'resolution_time', targetMins: 240, attainmentTarget: 95, attainmentMtd: 94.1, volumeMtd: 51, breachesMtd: 3, headroom: 0, kind: 'sla', clock: { start: 'validated_priority_set', stop: 'resolution_confirmed', pauses: ['awaiting_client (cap 8h/wo)', 'vendor_dependency (logged)'], calendar: 'client_biz_hours(Europe/Berlin)' }, credit: [{ band: '94–95%', pct: 2 }, { band: '90–94%', pct: 4 }, { band: '<90%', pct: 7 }], earnback: '3 consecutive months ≥ 97%' },
  { id: 'sla_data_finrep', tower: 'twr_dataplat', name: 'FINREP delivery by 06:00 CET', metric: 'delivery_time', targetMins: 0, attainmentTarget: 99, attainmentMtd: 97.4, volumeMtd: 18, breachesMtd: 1, headroom: 0, kind: 'sla', clock: { start: 'pipeline_scheduled', stop: 'contract_verified', pauses: ['upstream_vendor_dependency (logged)'], calendar: 'business_days(Europe/Berlin)' }, credit: [{ band: '97–99%', pct: 3 }, { band: '<97%', pct: 6 }], earnback: '2 consecutive months at 100%' },
...
export const OBLIGATIONS: Obligation[] = [
  ...
  { id: 'obl_002', title: 'SLA compliance & credits statement issued', owner: 'C. Duval', dueAt: daysAhead(8), cadence: 'Monthly', evidenceRequirement: 'Signed extract, clock audits attached', state: 'green' },
  { id: 'obl_003', title: 'DORA operational-resilience scenario test', owner: 'D. Kowalski', dueAt: daysAhead(23), cadence: 'Half-yearly', evidenceRequirement: 'Game-day report + regulator annex', state: 'amber' },
  ...
  { id: 'obl_005', title: 'ISO 27001 surveillance audit evidence pack', owner: 'N. Achebe', dueAt: daysAhead(12), cadence: 'Yearly', evidenceRequirement: 'Annex A control mapping + continuous evidence extract', state: 'amber' },
  ...
  { id: 'obl_007', title: 'Quarterly access recertification (platform + agent NHI)', owner: 'N. Achebe', dueAt: daysAgo(2), cadence: 'Quarterly', evidenceRequirement: 'Recertification log with reviewer identities', state: 'red' },
  { id: 'obl_008', title: 'Data-return commitment rehearsal', owner: 'A. Sørensen', dueAt: daysAhead(88), cadence: 'Yearly', evidenceRequirement: 'Rehearsal report + volumes returned', state: 'green' },
  { id: 'obl_009', title: 'Cyber insurance evidence refresh', owner: 'C. Duval', dueAt: daysAhead(56), cadence: 'Yearly', evidenceRequirement: 'Certificate of currency', state: 'green' },
...
export const INNOVATION: InnovationItem[] = [
  { id: 'inv_0051', title: 'Voice-channel intake for branch operations', source: 'client', sponsor: 'T. Bergmann', valueClass: 'experience', stage: 'idea', hypothesis: 'Branch staff raise 40% of EUC demand by phone; conversational intake removes the reformatting hop.' },
  ...
  { id: 'inv_0035', title: 'Self-service lockout recovery portal', source: 'client', sponsor: 'J. Halvorsen', valueClass: 'cost', stage: 'scaled', hypothesis: 'A guided self-service path removes the majority of post-MFA lockout demand.', projectedValueUsd: 384000, realisedValueUsd: 412000, verdict: 'verified', fundingSource: 'capacity_credits', cycleDays: 52, reuseCount: 2 },
  ...
  { id: 'inv_0028', title: 'Auto-generated Terraform from drift findings', source: 'agent', sponsor: 'J. Halvorsen', valueClass: 'cost', stage: 'delivered', hypothesis: 'Drift findings can be converted directly into reviewed IaC pull requests.', projectedValueUsd: 88000, fundingSource: 'capacity_credits', cycleDays: 40 },
  { id: 'inv_0022', title: 'Federated agent marketplace with client-authored skills', source: 'council', sponsor: 'H. Lindqvist', valueClass: 'capability', stage: 'verified', hypothesis: 'Nordbank engineers can author and publish skills into the client golden repo without Artizent in the loop.', projectedValueUsd: 0, realisedValueUsd: 0, verdict: 'verified', fundingSource: 'innovation_allowance', cycleDays: 88, reuseCount: 6 },
  ...
  { id: 'inv_0009', title: 'Zero-touch catalog provisioning', source: 'client', sponsor: 'J. Halvorsen', valueClass: 'cost', stage: 'scaled', hypothesis: 'Pre-approved catalog items need no human approval hop when the requester is in the entitled group.', projectedValueUsd: 196000, realisedValueUsd: 224000, verdict: 'verified', fundingSource: 'capacity_credits', cycleDays: 29, reuseCount: 4 },
]
...
export const CLOCK_AUDIT: { workObjectRef: string; sla: string; targetMins: number; events: ClockEvent[] } = {
  ...
  sla: 'P2 resolution, Retail Payments',
  targetMins: 240,
  events: [
    { at: '2027-02-14T08:12:00Z', event: 'clock_start', detail: 'Priority P2 validated by Sentinel; matrix v3 impact×urgency', evidence: 'ev_clk_0441' },
    { at: '2027-02-14T09:04:00Z', event: 'pause', detail: 'awaiting_client — requester asked to confirm the affected account range. Client acknowledgement recorded.', evidence: 'ev_clk_0442' },
    { at: '2027-02-14T11:38:00Z', event: 'resume', detail: 'Client responded, and the pause sat within the cap agreed for this work object.', evidence: 'ev_clk_0443' },
    { at: '2027-02-14T12:20:00Z', event: 'reclassify', detail: 'P2 → P2 (no change). Reclassification attempt logged and separately reported.', evidence: 'ev_clk_0444' },
    { at: '2027-02-14T13:47:00Z', event: 'clock_stop', detail: 'Resolution confirmed by verification pack canary_slo_v6.', evidence: 'ev_clk_0445' },
  ],
}
