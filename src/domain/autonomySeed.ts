...
export const PROMOTIONS = [
  ...
  { id: 'dm_09', at: 96, dir: 'down' as const, tower: 'twr_dataplat', ac: 'AC-49', from: 3, to: 2, why: 'Automatic demotion after a backfill emitted contract-violating nulls into the Oracle datamart — the one asset in this tower with no declared contract. Compensated in 4 minutes; grade B → C for 21 days. Client-visible from the moment it happened.', evidence: 'ev_dd41a8' },
