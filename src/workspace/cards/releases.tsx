...
/* ==========================================================================
   ...
   Blocking flags stop a release; the rest inform the go/no-go. A card carries
   the blocked ones first.
   ========================================================================== */
...
function ReleasesMetrics({ size }: CardProps) {
...
function ReleasesBody({ size }: CardProps) {
  const s = React.useMemo(() => releaseSummary(), [])
...
export const releasesView: ArtifactView = {
  Body: ReleasesBody,
  Metrics: ReleasesMetrics,
  page: {
    title: 'Releases',
    subtitle: 'Vendor and internal releases across applications and the data estate',
    agents: ['agt_sentryq', 'agt_forge', 'agt_custodian'],
    what: 'selecting and running regression packs and contract checks',
  },
}
