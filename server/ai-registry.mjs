...
export const PHASE_PURPOSE = { plan: 'plan_synthesis', outcome: 'narrative', brief: 'narrative', compile: 'plan_synthesis', converse: 'plan_synthesis' }

/** The AI function each gateway phase belongs to — the unit a customer may suspend. */
export const PHASE_FUNCTION = { plan: 'copilot.plan', outcome: 'herald.outcome', brief: 'herald.brief', compile: 'compiler.objectives', converse: 'astra.converse' }
